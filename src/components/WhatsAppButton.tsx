...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[88px] right-6 z-40 bg-[#25D366] text-white p-3.5 rounded-full shadow-xl hover:shadow-[#25D366]/30 border border-[#20B055] transition-all hover:scale-110 active:scale-95 group flex items-center justify-center animate-fade-in-up"
